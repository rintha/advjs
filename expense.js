function saveToLocalStorage(event) {
    ...
    axios.post("https://crudcrud.com/api/20e5fe28bae1452496391e2e3caa4f69/expenseTracker", obj)
                    .then((respone) => {
...
window.addEventListener("DOMContentLoaded", () => {
    axios.get("https://crudcrud.com/api/20e5fe28bae1452496391e2e3caa4f69/expenseTracker")
         .then((response) => {
            //  console.log(response) 
...
function deleteExpense(expenseId){
    axios.delete(`https://crudcrud.com/api/20e5fe28bae1452496391e2e3caa4f69/expenseTracker/${expenseId}`)
        .then((response) => {
